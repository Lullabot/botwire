...
- **Layouts:** Jekyll allows us to create layout templates, which are all located in the [_layouts](https://github.com/Lullabot/botwire/tree/master/_layouts) directory. Out of the box, Botwire only uses one layout file which is [_layouts/default.html](https://github.com/Lullabot/botwire/blob/styles-master/_layouts/default.html). This file contains the outer shell for most basic wireframes. The [_layouts/default.html](https://github.com/Lullabot/botwire/tree/master/_layouts/default.html) file is also where you'll find all of the CSS, Javascript and various IE fixes being loaded in the document head.
